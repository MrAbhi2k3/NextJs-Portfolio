...
const Footer = () => {
  ...
  return (
    <footer className="mt-12 border-t-4 border-foreground bg-card py-6 px-4 sm:px-8">
      <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 text-center sm:flex-row sm:text-left">
        <div>
          ...
          <p className="mt-1.5 text-xs sm:text-sm font-bold text-muted-foreground break-all">
